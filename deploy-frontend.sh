...
docker run --detach \
    ...
    # deploy-frontend-internal and precise-code-intel-worker containers
    # as well.
    ...
    -e PRECISE_CODE_INTEL_AWS_ACCESS_KEY_ID='AKIAIOSFODNN7EXAMPLE' \
    -e PRECISE_CODE_INTEL_AWS_SECRET_ACCESS_KEY='wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY' \
    -e PRECISE_CODE_INTEL_AWS_ENDPOINT=http://minio:9000 \
    -e PRECISE_CODE_INTEL_AWS_REGION=us-east-1 \
    -e PRECISE_CODE_INTEL_AWS_S3_FORCE_PATH_STYLE=true \
    -v $VOLUME:/mnt/cache \
